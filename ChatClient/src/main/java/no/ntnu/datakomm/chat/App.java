...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        URL fxmlUrl = this.getClass().getResource("layout.fxml");
        URL cssUrl = this.getClass().getResource("styles/style.css");
        URL iconUrl = this.getClass().getResource("styles/ntnu.png");
        Parent root = null;
